...
export default function HeaderScrollScreen() {
  ...
  const sliderAnimatedStyle = useAnimatedStyle(() => ({
    ...
    transform: [
      {
        scale: interpolate(scrollY.value, [0, 150], [1, 0]),
      },
      {
        translateY: interpolate(scrollY.value, [0, 150], [0, -100]),
      },
    ],
  }));
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Image
          style={{ height: IMAGE_HEIGHT, width: 180 }}
      ...
      >
        ...
        <View style={styles.infoGroup}>
          ...
          <Text style={styles.text}>
            {" "}
            - Capacidade: 8GB (4GB Soldada + 4GB Módulo)
          </Text>
